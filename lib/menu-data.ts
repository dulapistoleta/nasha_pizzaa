 ...
 *
 * Цены и позиции из блока «Рекомендуем» — реальные.
...
export const CATEGORIES: Category[] = [
  { id: "top", label: "Рекомендуем", emoji: "⭐", hint: "Восемь позиций, которые мы советуем" },
...
/** Ровно 8 позиций блока «Рекомендуем», отсортированные по рангу. */
